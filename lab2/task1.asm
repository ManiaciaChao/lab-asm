...
data segment use16
    ...
    state_cs dw ?
    ; model
    goods Good <'PEN$',3,56,70,loopc,0,0>,<'BOOK$',7,30,25,loopc,0,0>
    ; goods Goodd <'PEN$',3,56,70,loopc,0,0>, number dup (<'BOOK$',7,30,25,loopc,0,0>)
    ; goods Good number dup(<'PEN$',3,56,70,loopc,0,0>)
    goods_types dw 2;
    ; message for menu
    msg_menu_hr db '--------------------------------$'
